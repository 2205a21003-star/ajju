...
st.title("2205A21003-Ps3")
st.write("calculate resonance frequency (FR), band width (BW), quality factor (Q), upper cutoff frequency (FU), and lower cutoff frequency (FL) based on R, L, and C values for series resonance circuit ")
import math
def output(R,L,C):
